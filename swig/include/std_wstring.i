...
%typemap(imtype,
         inattributes="[UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(WStringMarshaler))]",
         outattributes="[return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(WStringMarshaler))]"
         ) wstring "string"
...
%typemap(imtype,
         inattributes="[MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(WStringMarshaler))]",
         outattributes="[return: MarshalAs(UnmanagedType.CustomMarshaler, MarshalTypeRef = typeof(WStringMarshaler))]"
